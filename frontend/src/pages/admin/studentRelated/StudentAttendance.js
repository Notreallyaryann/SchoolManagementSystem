                        ...
                        <div className="max-w-md w-full px-4 py-16">
                            ...
                            <form onSubmit={submitHandler} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={loader}
                                    className="w-full py-2.5 px-4 bg-purple-600 text-white font-medium rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-70 flex justify-center items-center"
                                >
                                    {loader ? (
